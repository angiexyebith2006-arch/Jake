    ...
    <main class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-2xl rounded-2xl border border-gray-200 overflow-hidden">
                ...
                @php $tipo = strtolower($movimiento->categoria->tipo_finanza ?? ''); @endphp

                <!-- Header -->
                <div class="px-6 py-4 {{ $tipo === 'ingreso' ? 'bg-gradient-to-r from-green-600 to-teal-700' : 'bg-gradient-to-r from-red-600 to-orange-700' }}">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-lg font-medium text-gray-900">
                                    <i class="fas fa-tag {{ $tipo === 'ingreso' ? 'text-green-500' : 'text-red-500' }} mr-2"></i>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="mt-2 p-4 bg-gray-50 rounded-lg">
                                    <p class="text-gray-700">{{ $movimiento->descripcion ?? 'Sin descripción' }}</p>
                                </div>
                            </div>
                    ...
                    <div class="mt-8 p-6 bg-blue-50 rounded-xl">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-blue-800">{{ $movimiento->categoria->tipo_finanza ?? '—' }}</p>
                            </div>
                            @if($movimiento->categoria->descripcion ?? false)
