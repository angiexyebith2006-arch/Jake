        ...
        <div class="bg-white shadow-2xl rounded-2xl border border-gray-200 overflow-hidden max-w-4xl mx-auto">
            ...
            <div class="bg-gradient-to-r from-green-600 to-green-700 px-6 py-5">
                <div class="flex justify-between items-center">
                    <div>
                        <h2 class="text-white text-2xl font-bold">Crear Vista</h2>
                        <p class="text-green-100 text-sm mt-1">Registra una nueva vista del sistema</p>
                    </div>
            ...
            <form action="{{ route('vistas.guardar') }}" method="POST">
                @csrf
                ...
                <div class="p-8 space-y-6">
                    ...
                    <div class="bg-gradient-to-r from-green-50 to-green-50 rounded-xl p-4 border border-green-200">
                        <label class="block text-sm font-medium text-gray-700 mb-2">
                            <i class="fas fa-info-circle mr-2 text-green-600"></i>Información de la Vista
                        </label>
                        <p class="text-sm text-gray-600">
                            Las vistas representan las diferentes secciones o módulos del sistema a los que los usuarios pueden acceder.
                            Ejemplos: <strong>usuarios, programacion, asistencia, finanzas, chat, autorizaciones</strong>
                        </p>
                    </div>
                    ...
                    <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200">
                        ...
                        <button type="submit" 
                            ...
                            <i class="fas fa-save mr-2"></i> Guardar Vista
                        </button>
                    </div>
