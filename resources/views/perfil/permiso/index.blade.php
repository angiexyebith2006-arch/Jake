...
<main class="p-6 max-w-7xl mx-auto">
    ...
    <div class="bg-white shadow-2xl rounded-2xl border border-gray-200 overflow-hidden">
                ...
                <div class="flex flex-col lg:flex-row gap-3 lg:items-center w-full lg:w-auto">
                    ...
                    <div class="flex flex-wrap gap-2 items-center">
                        ...
                        <a href="{{ route('perfil.index') }}"
                           class="{{ $btnClass }} bg-white text-gray-700 hover:bg-gray-100">
                        ...
                        <div class="relative" id="dropdownWrapper">
                            ...
                            <button onclick="toggleDropdown()"
                                    class="{{ $btnClass }} bg-white text-green-700 hover:bg-green-50">
                            ...
                            <div id="dropdownMenu"
                                 class="hidden absolute right-0 mt-2 w-52 bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden z-50">
                                ...
                                <a href="{{ route('vistas.index') }}"
                                   class="flex items-center gap-3 px-4 py-3 text-sm hover:bg-gray-50 border-t border-gray-100">
        ...
        <div class="px-6 py-3 bg-gray-100 border-b border-gray-200 text-sm text-gray-600">
            ...
            Mostrando
            <span id="totalVisibles" class="font-semibold">
                {{ count($agrupados) }}
            </span>
            permisos
        </div>
                ...
                <table class="min-w-full">
                        ...
                        <tr>
                            @foreach([
                                ...
                                <th class="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">
                                    <i class="fas {{ $icon }} mr-1 text-green-500"></i>
                                    {{ $titulo }}
                                </th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        ...
                        @foreach($agrupados as $grupo)
                                ...
                                <tr class="fila-permiso hover:bg-green-50 transition-colors"
                                    ...
                                    @if($loop->first)
                                        ...
                                        <td class="px-6 py-4 align-top"
                                            rowspan="{{ count($grupo['vistas']) }}">

                                            <div class="flex items-center gap-3">

                                                <div class="w-9 h-9 rounded-full bg-gradient-to-r from-green-500 to-emerald-500 flex items-center justify-center text-white font-bold text-sm">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="flex flex-wrap gap-1.5">
                                            ...
                                            @foreach($info['acciones'] as $accion)
                                                ...
                                                @php
                                                    [$color, $icon] = $badges[$accion]
                                                        ?? ['bg-gray-100 text-gray-600', 'fa-circle'];
                                                @endphp
                            ...
                            @unless($loop->last)
                                <tr>
                                    <td colspan="4" class="bg-gray-50 py-1"></td>
                                </tr>
                            @endunless
        ...
        @else
            ...
            <div class="py-20 text-center">
                ...
                <a href="{{ route('permisos.create') }}"
                   class="inline-flex items-center gap-2 text-green-600 text-sm mt-3 hover:underline">
        ...
        filtro?.addEventListener('input', () => {
            ...
            filas.forEach(fila => {
                ...
                const coincide = !texto ||
                    ['nombre', 'vista']
                        .some(k => (fila.dataset[k] || '').includes(texto));

                fila.style.display = coincide ? '' : 'none';

                if (coincide) {
                    visibles++;
                    grupos.add(fila.dataset.nombre);
                }
            });

            $('totalVisibles').textContent = grupos.size;
            $('sin-resultados')?.classList.toggle('hidden', visibles > 0);
        });
    });
