        ...
        <div class="bg-white shadow-2xl rounded-2xl border border-gray-200 overflow-hidden max-w-4xl mx-auto">
            ...
            <div class="bg-gradient-to-r from-green-600 to-green-700 px-6 py-5">
                <div class="flex justify-between items-center">
                    <div>
                        <h2 class="text-white text-2xl font-bold">Editar Acción</h2>
                        <p class="text-green-100 text-sm mt-1">Modifica el nombre de la acción del sistema</p>
                    </div>
            ...
            <form action="{{ route('acciones.actualizar', $accion['idAccion']) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="p-8 space-y-6">
                    ...
                    <div class="bg-gradient-to-r from-green-50 to-green-50 rounded-xl p-4 border border-green-200">
                        <label class="block text-sm font-medium text-gray-700 mb-2">
                            <i class="fas fa-cogs mr-2 text-green-600"></i>Acción a editar
                        </label>
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-lg font-semibold text-gray-800 capitalize">
                                    {{ $accion['nombreAccion'] ?? 'N/A' }}
                                </p>
                                <p class="text-sm text-gray-500">ID: #{{ $accion['idAccion'] ?? 'N/A' }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text"
                               name="nombreAccion"
                               value="{{ old('nombreAccion', $accion['nombreAccion']) }}"
                    ...
                    <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200">
                        ...
                        <button type="submit" 
                            ...
                            <i class="fas fa-save mr-2"></i> Actualizar Acción
                        </button>
                    </div>
