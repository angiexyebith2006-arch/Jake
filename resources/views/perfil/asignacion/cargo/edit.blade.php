        ...
        <div class="bg-white shadow-2xl rounded-2xl border border-gray-200 overflow-hidden max-w-4xl mx-auto">
            ...
            <div class="bg-gradient-to-r from-green-600 to-emerald-600 px-6 py-5">
                <div class="flex justify-between items-center">
                    <div>
                        <h2 class="text-white text-2xl font-bold">Editar Cargo</h2>
                        <p class="text-green-100 text-sm mt-1">Modifica el nombre del cargo</p>
                    </div>
                ...
                <div class="p-8 space-y-6">
                    ...
                    <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-4 border border-green-200">
                        <label class="block text-sm font-medium text-gray-700 mb-2">
                            <i class="fas fa-briefcase mr-2 text-green-600"></i>Cargo a editar
                        </label>
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-full bg-gradient-to-r from-green-500 to-emerald-500 flex items-center justify-center text-white font-bold text-sm">
                                {{ strtoupper(substr($cargo['nombreCargo'] ?? 'C', 0, 1)) }}
                            </div>
                            <div>
                                <p class="text-lg font-semibold text-gray-800">
                                    {{ $cargo['nombreCargo'] ?? 'N/A' }}
                                </p>
                                <p class="text-sm text-gray-500">ID: #{{ $cargo['idCargo'] ?? 'N/A' }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text"
                               ...
                               maxlength="80"
                               placeholder="Ej: Pastor Principal, Líder de Alabanza, Tesorero..."
                    ...
                    <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200">
                        ...
                        <button type="submit" 
                            ...
                            <i class="fas fa-save mr-2"></i> Actualizar Cargo
                        </button>
                    </div>
