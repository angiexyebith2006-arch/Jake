        ...
        <div class="bg-white shadow-2xl rounded-2xl border border-gray-200 overflow-hidden max-w-4xl mx-auto">
            ...
            <div class="bg-gradient-to-r from-green-600 to-green-700 px-6 py-5">
                <div class="flex justify-between items-center">
                    <div>
                        <h2 class="text-white text-2xl font-bold">Editar Rol</h2>
                        <p class="text-green-100 text-sm mt-1">Modifica el nombre o descripción del rol</p>
                    </div>
                ...
                <div class="p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="descripcion"
                                  ...
                                  maxlength="255"
                                  rows="4"
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition resize-none"
                                  placeholder="Describe las responsabilidades y permisos de este rol...">{{ old('descripcion', $rol['descripcion'] ?? '') }}</textarea>
