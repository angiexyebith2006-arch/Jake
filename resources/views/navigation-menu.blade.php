            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center space-x-3 group">
                        <div class="bg-yellow-400 p-2 rounded-xl shadow-lg transform group-hover:scale-105 transition-transform duration-300">
                           
                        </div>
                        <span class="text-white font-bold text-xl hidden lg:block transform group-hover:translate-x-1 transition-transform duration-300">JAKE</span>
                    </a>
                </div>
