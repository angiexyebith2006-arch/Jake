<x-guest-layout style="background-image: url('{{ asset('images/fondo.png') }}');">
    <x-authentication-card
        ...
        <x-slot name="logo">
            <img src="{{ asset('images/logo_negro.png') }}" alt="Logo JAKE" class="h-12 w-12 rounded-lg">
        </x-slot>

        {{-- ELIMINA ESTA LÍNEA PARA QUE NO APAREZCA:
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="nombre" value="{{ old('nombre') }}"
                        ...
                        class="w-full px-4 py-3 rounded-xl bg-gray-100 border border-transparent
                               focus:outline-none focus:ring-2 focus:ring-blue-1000 focus:bg-white transition">

                    @error('nombre')
                        <p class="text-white-1000 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
